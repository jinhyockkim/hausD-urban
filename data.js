...
const FLOORS = [
  {
    ...
    buildings: [
      { id: 'F', x:  50, y:  60, cols: 4, rows: 5, cw: 72, ch: 54, labelSide: 'left',
        fill: '#CFEAC8', stroke: '#7FB873', chip: '#9CD18E' },
      { id: 'A', x: 432, y:  60, cols: 5, rows: 5, cw: 58, ch: 54, labelSide: 'right',
        fill: '#FFE3BD', stroke: '#E8A85C', chip: '#F6C26B' },
      { id: 'E', x:  50, y: 410, cols: 4, rows: 6, cw: 72, ch: 54, labelSide: 'left',
        fill: '#FAEFB4', stroke: '#CDB54E', chip: '#E8D26E' },
      { id: 'B', x: 432, y: 410, cols: 4, rows: 5, cw: 72, ch: 54, labelSide: 'right',
        fill: '#E2D9F8', stroke: '#9C8AD6', chip: '#BCA9EC' },
      { id: 'D', x:  50, y: 815, cols: 4, rows: 5, cw: 72, ch: 54, labelSide: 'left',
        fill: '#C8DEF6', stroke: '#7AA3D4', chip: '#9DC2E8' },
      { id: 'C', x: 432, y: 815, cols: 4, rows: 5, cw: 72, ch: 54, labelSide: 'right',
  ...
  },
  {
    ...
    buildings: [
      { id: 'H', x:  50, y:  60,  cols: 4, rows: 4, cw: 72, ch: 54, labelSide: 'left',
        fill: '#D9F0DC', stroke: '#74B585', chip: '#96CCA3' },
      { id: 'A', x: 432, y:  60,  cols: 4, rows: 5, cw: 72, ch: 54, labelSide: 'right',
        fill: '#FFE3BD', stroke: '#E8A85C', chip: '#F6C26B' },
      { id: 'G', x:  50, y: 330,  cols: 4, rows: 6, cw: 72, ch: 54, labelSide: 'left',
        fill: '#FCE8AE', stroke: '#D9A93F', chip: '#EBC868' },
      { id: 'B', x: 432, y: 385,  cols: 4, rows: 6, cw: 72, ch: 54, labelSide: 'right',
        fill: '#E2D9F8', stroke: '#9C8AD6', chip: '#BCA9EC' },
      ...
      { id: 'D', x: 432, y: 1020, cols: 4, rows: 6, cw: 72, ch: 46, labelSide: 'right',
        fill: '#C8DEF6', stroke: '#7AA3D4', chip: '#9DC2E8' },
    ],
  },
];
...
const TENANTS = [
  ...
  { id:'1f-bbq',      floor:'1F', name:'BBQ 치킨',          cat:'식당',   verified:true,  blocks:[{b:'F', r:[2,0,2,1]}] },
  { id:'1f-bebe',     floor:'1F', name:'베베꼬',            cat:'식당',   verified:false, blocks:[{b:'F', r:[0,1,1,1]}] },
  { id:'1f-jinro',    floor:'1F', name:'진로상회',          cat:'술집',   verified:true,  blocks:[{b:'F', r:[1,1,2,2]}] },
  { id:'1f-f-x1',     floor:'1F', name:'미확인',            cat:'미확인', verified:false, blocks:[{b:'F', r:[3,1,1,1]}] },
  { id:'1f-surin',    floor:'1F', name:'수린',              cat:'식당',   verified:false, blocks:[{b:'F', r:[0,2,1,1]}] },
